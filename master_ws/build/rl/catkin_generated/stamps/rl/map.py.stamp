...
import roslib; roslib.load_manifest('rviz_python_tutorial') #change to load the manifest for Felipe's map
import sys
...
class MyViz( QWidget ):
    def __init__(self):
        ...
        config = rviz.Config()
        reader.readFile( config, "$(find eng_rf)/rviz/main.rviz" ) #Change to read Felipe's Rviz file for the map
